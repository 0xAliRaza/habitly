    ...
    <div class="row">
      <div class="d-flex justify-content-end">
        <div class="mb-4">
          ...
          <button v-else class="btn-close" @click.prevent="toggleForm"></button>
        </div>
      </div>
      <div class="row">
        <div class="col-12">
          <div class="mb-5" v-if="formVisible">
    ...
    <div class="row justify-content-center">
      <div class="col-sm-12">
        ...
        >
          ...
          <div class="my-2 align-self-end" v-if="stacks.length > 0">
          ...
          <div class="py-3" v-if="stacks.length < 1">
            <p class="alert-info">You haven't created any habit stacks yet.</p>
          </div>
          <div class="py-2" v-else>
            <div v-if="!tableView">
              ...
              >
                ...
                <button
                  class="btn btn--stack-delete d-inline-flex align-items-center"
